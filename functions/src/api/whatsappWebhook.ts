...
export const whatsappWebhook = onRequest(
  { secrets: [WHATSAPP_VERIFY_TOKEN, WHATSAPP_ACCESS_TOKEN, WHATSAPP_PHONE_NUMBER_ID, OPENAI_API_KEY, GOOGLE_GENAI_API_KEY, RAZORPAY_KEY_ID, RAZORPAY_KEY_SECRET, OWNER_PHONES, WHATSAPP_PHONE_NUMBER] },
  async (req, res) => {
    if (req.method === "GET") {
